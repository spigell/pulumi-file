...
namespace Pulumi.File
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/spigell/pulumi-file";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("Pulumi.File.version.txt");
    ...
    internal sealed class FileResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public FileResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
